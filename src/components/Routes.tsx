...
const Routes: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-6">
      ...
      <Reveal delay={0.4}>
        <div className="mt-20 bg-stone-50 p-10 rounded-[2.5rem] border border-stone-100 text-center flex flex-col md:flex-row items-center justify-between gap-8 px-12">
