    ...
    <section className="container mx-auto px-6">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {RACE_CATEGORIES.map((cat, idx) => (
          <Reveal key={cat.id} delay={idx * 0.2}>
            <div
              className="group bg-white rounded-[2.5rem] overflow-hidden shadow-xl border border-stone-100 hover:border-gold/50 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl h-full"
            >
      ...
      <Reveal delay={0.4}>
        <div className="mt-20 bg-maroon-900 text-white p-10 md:p-14 rounded-[3rem] flex flex-col md:flex-row items-center justify-between gap-10 relative overflow-hidden shadow-2xl">
